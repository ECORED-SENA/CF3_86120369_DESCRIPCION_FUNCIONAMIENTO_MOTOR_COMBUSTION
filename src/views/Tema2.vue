...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p(data-aos="fade-down") Conozcamos cada uno de estos diagramas.
      ...
      .col-12
        .p-5
          .row.justify-content-center.align-items-center
            ...
            .col-lg-4.p-lg-4.p-md-0.mt-4.mt-lg-0(data-aos="fade-right")
          ...
          .row.justify-content-center.align-items-center
            ...
            .col-lg-8.mt-3.mt-md-2.p-md-0(data-aos="fade-left")
    ...
    .row.align-items-center
      .col-md-auto.d-none.d-lg-block(data-aos="fade-right")
        figure
          img(src="@/assets/curso/tema1/img12.png", alt="", style="width: auto").m-auto
      .col.p-md-0(data-aos="fade-left")
    ...
    .row.justify-content-center.mt-4
      .col-10
        ...
        p.mt-4(data-aos="fade-right") Si se realiza una optimización de la leva se podrían obtener también otras formas del llenado, incrementando simplemente la altura y perfil de la leva original.
