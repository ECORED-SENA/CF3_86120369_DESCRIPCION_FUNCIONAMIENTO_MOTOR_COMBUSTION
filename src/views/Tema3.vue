        ...
        .col-8
          ...
          .row.mt-4
            .col-md-auto.d-none.d-lg-block
              figure
                img(src="@/assets/curso/tema3/img1.png", alt="", style="width: 90px").m-auto
            .col
              p.mb-0 En estos motores estaba alojado el eje de lavas en la parte baja del bloque, para que un sistema de piñones en toma constante impulse al eje o a los ejes de levas. Sobre cada leva, ya sea de admisión o de escape, se instalaba un propulsor, que se deslizaba sobre un pequeño orificio cilíndrico trabajado en el mismo bloque.
      ...
      .row
        ...
        .col-7
          .row
            .col-md-auto.d-none.d-lg-block
              figure
                img(src="@/assets/curso/tema3/img5.png", alt="", style="width: 100px").m-auto
            .col
              p.mb-0 El sistema de válvulas en el bloque de cilindros no permitía un buen desempeño del motor, debido al diseño mismo de la cámara de combustión, y además porque se requería de un bloque más ancho para alojar al eje de levas y los mecanismos de empuje de válvulas.
    ...
    .row.justify-content-center.mt-4.bg-t3-4
      .col-10
        .row.justify-content-center
          ...
          .col-md-6.col-lg-6.mb-4.mb-lg-0(data-aos="fade-down")
            .p-4.bg-t3-3
              figure
          ...
          .row
            .col-7
              .row
                .col-md-auto.d-none.d-lg-block
                  figure
                    img(src="@/assets/curso/tema3/img10.png", alt="", style="width: 90px").m-auto
                .col
                  p.mb-0 En los motores modernos no solamente se puede disponer de un solo eje de levas, sino que se puede instalar dos en cada culata, es decir un eje para las válvulas de admisión y otro eje para las válvulas de escape.
      ...
      .row
        ...
        .col-8
          .row
            ...
            .col
              p.mb-0 Tanto en este caso, como en el anterior de palancas basculantes, se tiene un tornillo de calibración o una excéntrica, que permiten la calibración de válvulas, compensando de esta manera el desgaste del sistema, el asentamiento mismo de las válvulas y las dilataciones producidas de cada parte.
              
          .row.justify-content-center.mb-5.align-items-center.mt-4
        ...
        .p-5
          ...
          .row.justify-content-center.mt-4
            .col-5
              ...
              figure
                img(src='@/assets/curso/tema3/img19.png', alt='Imagen que presenta el eje de levas debajo del balancín.', style="width: 400px")
            .col-3
              figure
